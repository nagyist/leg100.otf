...
type Querier interface {
	...
	UpdateAgentStatus(ctx context.Context, params UpdateAgentStatusParams) (pgtype.Text, error)
	// UpdateAgentStatusBatch enqueues a UpdateAgentStatus query into batch to be executed
	// later by the batch.
	UpdateAgentStatusBatch(batch genericBatch, params UpdateAgentStatusParams)
...
func (q *DBQuerier) InsertAgent(ctx context.Context, params InsertAgentParams) (pgconn.CommandTag, error) {
	...
	cmdTag, err := q.conn.Exec(ctx, insertAgentSQL, params.AgentID, params.Status, params.IpAddress, params.Version, params.Name, params.External, params.LastSeen, params.OrganizationName)
	if err != nil {
...
func (q *DBQuerier) InsertAgentBatch(batch genericBatch, params InsertAgentParams) {
	batch.Queue(insertAgentSQL, params.AgentID, params.Status, params.IpAddress, params.Version, params.Name, params.External, params.LastSeen, params.OrganizationName)
}
...
func (q *DBQuerier) UpdateAgentStatus(ctx context.Context, params UpdateAgentStatusParams) (pgtype.Text, error) {
	ctx = context.WithValue(ctx, "pggen_query_name", "UpdateAgentStatus")
	row := q.conn.QueryRow(ctx, updateAgentStatusSQL, params.Status, params.LastSeen, params.AgentID)
...
func (q *DBQuerier) UpdateAgentStatusBatch(batch genericBatch, params UpdateAgentStatusParams) {
	batch.Queue(updateAgentStatusSQL, params.Status, params.LastSeen, params.AgentID)
}

// UpdateAgentStatusScan implements Querier.UpdateAgentStatusScan.
func (q *DBQuerier) UpdateAgentStatusScan(results pgx.BatchResults) (pgtype.Text, error) {
